...
import com.shvmsaini.vision.GraphicOverlaykt.Graphic
import java.util.*
 ...
 *
 */
class GraphicOverlaykt(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
     ...
     * instances to the overlay using [GraphicOverlaykt.add].
     */
